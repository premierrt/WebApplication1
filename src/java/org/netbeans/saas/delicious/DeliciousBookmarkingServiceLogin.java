 ...
 * @author rafal
 */
@WebServlet(name = "DeliciousBookmarkingServiceLogin", urlPatterns = "/DeliciousBookmarkingServiceLogin")
public class DeliciousBookmarkingServiceLogin extends HttpServlet {
    
    private static String CLASS_NAME = DeliciousBookmarkingServiceLogin.class.getSimpleName();
