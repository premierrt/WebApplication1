 ...
 * @author rafal
 */
@WebServlet(name = "DeliciousBookmarkingServiceCallback", urlPatterns = "/DeliciousBookmarkingServiceCallback")
public class DeliciousBookmarkingServiceCallback extends HttpServlet {

    private static String CLASS_NAME = DeliciousBookmarkingServiceCallback.class.getSimpleName();
