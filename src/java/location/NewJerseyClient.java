...
public class NewJerseyClient {
   ...
   // private static final String BASE_URI = "http://api.wxbug.net";
    private static final String BASE_URI = "http://i.wxbug.net/REST/SP/";
    

    public NewJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("getStationsXML.aspx");
    }
     ...
     */
    public <T> T getStationsXML(Class<T> responseType, String aCode, String... optionalQueryParams) throws ClientErrorException {
        //zmienilem aCode na api_key
        webTarget = webTarget.queryParam("api_key", aCode);
